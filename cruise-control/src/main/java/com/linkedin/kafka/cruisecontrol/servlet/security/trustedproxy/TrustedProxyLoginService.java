...
public class TrustedProxyLoginService extends ContainerLifeCycle implements LoginService {
   ...
   * @param userStore authorizes the user that is passed in via the doAs header
   ...
   */
  public TrustedProxyLoginService(String realm, ExposedPropertyUserStore userStore, List<String> trustedProxies,
                                  String trustedProxyIpPattern, boolean fallbackToSpnegoAllowed, List<String> principalToLocalRules) {
    _delegateSpnegoLoginService = new SpnegoLoginService(realm, userStore, principalToLocalRules);
    _fallbackSpnegoLoginService = new SpnegoLoginService(realm, userStore, principalToLocalRules);
  ...
  TrustedProxyLoginService(SpnegoLoginService delegateSpnegoLoginService,
                           ...
                           ExposedPropertyUserStore userStore, boolean fallbackToSpnegoAllowed) {
