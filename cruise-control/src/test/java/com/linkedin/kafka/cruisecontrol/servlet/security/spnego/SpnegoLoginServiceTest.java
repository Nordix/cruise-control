...
public class SpnegoLoginServiceTest {
    ...
    private final ExposedPropertyUserStore _mockUserStore = mock(ExposedPropertyUserStore.class);
    ...
    public void testLoginWithoutKerberosRules() {
        ...
        replay(_mockLoginService, _mockUserStore, _mockAuthIdentity, _mockIdentityService);
    ...
    private SpnegoLoginService createAuthServiceWithMocking(String name, String finalName, SPNEGOUserPrincipal principal) {
        ...
        expect(_mockUserStore.getUserIdentity(finalName)).andReturn(_mockRoleIdentity);
    ...
    private void assertUserIdentity(String username, UserIdentity userIdentity) {
        ...
        verify(_mockLoginService, _mockUserStore, _mockAuthIdentity, _mockIdentityService);
    }
